...
A partir de 01/09/2024, foi iniciado o projeto de **expansão** do sistema para os demais equipamentos da nossa rede de atendimento, bem como a implementação de diversas melhorias e ajustes com base nos feedbacks recebidos, e o desenvolvimento do módulo de atendimentos.
...
Em 27/02/2025 foi implantada a [**versão 3.0.0**](../historico-de-versoes/versao-3/) do SIAD, trazendo a primeira funcionalidade para gestão de benefícios, o **Transcidadania**.
