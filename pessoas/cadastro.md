...
{% hint style="warning" %}
Apesar de não ser obrigatório, a etapa de conferir se o CPF já está cadastrado na base de dados se torna bastante importante para evitar duplicidades no cadastro.
{% endhint %}
