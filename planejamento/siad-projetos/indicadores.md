...
{% hint style="info" %}
Por enquanto, apenas os projetos relacionados ao **Planejamento Estratégico** da SMDHC possuem indicadores cadastrados. Porém, a ideia é que, com o tempo, _todos_ os projetos que possuem algum indicador sejam .
{% endhint %}
...
Assim, neste exemplo, basta que a área informe o número de formações realizadas no 1º trimestre do ano de 2026, forneça mais informações na área de observações (se quiser) e clique em _<mark style="color:purple;">Salvar alterações</mark>_.&#x20;
